        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (Inputan.Text != "" && txtUsername.Text != "")
                {
                    ...
                    query = string.Format("insert into cucilipat (id, nama, total, username, harga, status)  values ('{0}','{1}', '{2}', '{3}', '{4}', '{5}');", id_transaksi, "Cuci Bersih", Inputan.Text, txtUsername.Text, harga, "In Queue");
